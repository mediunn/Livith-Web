        ...
        >
          ...
          <Sheet.Content className="!px-12 space-y-11 py-17">
            ...
            >
              ...
              <p className="text-lyricsTranslation text-body-md font-medium font-NotoSansKR ">
                콘서트 삭제하기
              </p>
            </div>
          </Sheet.Content>
